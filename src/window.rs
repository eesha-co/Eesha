...
/// A Eesha window is a Winit window containing several web views.
pub struct Window {
...
impl Window {
    /// Create a Eesha window from Winit window and return the rendering context.
    pub fn new(
        evl: &ActiveEventLoop,
    ...
    /// Create a Eesha window with the rendering context.
    ...
    pub fn create_panel(
        ...
        let url = ServoUrl::parse("eesha://resources/components/panel.html").unwrap();
    ...
    pub fn create_tab(
        ...
        log::debug!("Eesha Window {:?} adds webview {}", self.id(), webview_id);
    }
        ...
        match event {
            ...
            WindowEvent::MouseInput { state, button, .. } => {
                ...
                let button: MouseButton = match button {
                    ...
                    _ => {
                        log::trace!(
                            "Eesha Window isn't supporting this mouse button yet: {button:?}"
                        );
                        return;
                    }
                };
            ...
            WindowEvent::KeyboardInput { event, .. } => {
                ...
                log::trace!("Eesha is handling {:?}", event);
            ...
            e => log::trace!("Eesha Window isn't supporting this window event yet: {e:?}"),
        }
    }
    ...
    pub fn handle_servo_message(
        ...
        // Handle message in Eesha WebView
