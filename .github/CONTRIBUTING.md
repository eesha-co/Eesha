...
Hello! We, the maintainers, are very pleased that you are interested in contributing to Eesha. However, before you submit your contribution, please take a moment to read the [Code of Conduct](CODE_OF_CONDUCT.md) and the appropriate section for the contribution you plan to make:
...
- If you have a question, you can get quick answers from the [Eesha Zulip](https://eesha.zulipchat.com/).

- Try to search for your issue, it may have already been answered or even fixed in the main branch (`main`).

- Check if the issue is reproducible with the latest version of Eesha. If you are using a nightly release, please indicate the specific version you are using.
